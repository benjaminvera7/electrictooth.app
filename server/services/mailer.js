                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                ...
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#89DBFF" style="border-radius: 6px;">
                                                    <a href="${config.host}/reset/${user._id}/${resetToken}" target="_blank"
                                                        style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: black; text-decoration: none; border-radius: 6px;">Reset
                                                        Password</a>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br> ET</p>
                        </td>
                    </tr>
                    <!-- end copy -->
